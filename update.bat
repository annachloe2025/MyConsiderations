@echo off
REM ============================================================
REM  MyConsiderations - commit source + deploy site to GitHub Pages
...
cd /d C:\Users\hoeho\Documents\Claude\MyProfile\MyConsiderations

echo.
echo ================================================================
echo   MyConsiderations  -  update and publish
echo ================================================================
echo.
...
echo ================================================================
echo   Done!
echo   Site URL: https://annachloe2025.github.io/MyConsiderations/
echo ================================================================
echo.
pause
